...
// ---------------------------------------------------------------------------
// 1. GENERATE OBITUARY & LIFE STORY PDF
// ---------------------------------------------------------------------------
function generateObituaryPdf() {
  ...
  pages.forEach((pageData, pageIdx) => {
    ...
    doc.text(`Page ${pageIdx + 1} of 3`, pageWidth - margin, pageHeight - 24, { align: 'right' });
  });
...
// ---------------------------------------------------------------------------
// 2. GENERATE CELEBRATION ORDER OF SERVICE PDF
// ---------------------------------------------------------------------------
function generateOrderOfServicePdf() {
  ...
  // Function to render each quarter
  const quarters = [
    {
